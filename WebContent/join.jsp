	...
	<div class="container">
			<div class="jumbotron" style="margin-top: 20px;">
				<form method="post" action="joinAction.jsp">
					<h3 style="text-align: center; margin-bottom:20px;">회원가입 화면</h3>
					...
					<div class="custom-control custom-checkbox"  style="margin-bottom:20px;">
              			<input type="checkbox" class="custom-control-input" id="same-address" name="userAdmin" value="1">
              			<label class="custom-control-label" for="same-address">총대로 가입하시려면 체크해 주세요</label>
            		</div>
